...
dag = DAG(
    'accutuning_ml_parse_call2', default_args=default_args, schedule_interval=timedelta(minutes=10))
...
#     cmds=["bash", "-cx"],
    cmds=["bash", "-cx", "python3"],
    arguments=["/code/manage.py", "ml_parse_success", "--experiment=19",  "--uuid='4043104546ca4c0597ba5341607ba06f'", "--timeout=200"],   
    get_logs=True,
    dag=dag,        
...
#     cmds=["bash", "-cx"],
    cmds=["bash", "-cx", "python3"],
    arguments=["/code/manage.py", "ml_parse_fail", "--experiment=19",  "--uuid='4043104546ca4c0597ba5341607ba06f'", "--timeout=200"],   
    get_logs=True,
    dag=dag,        
