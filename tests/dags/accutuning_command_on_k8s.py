...
def make_env_var():
    ...
    env_dict = {
        'ACCUTUNING_WORKSPACE': json.loads('{{dag_run.confaccutuning_env_vars }}').get('ACCUTUNING_WORKSPACE'),
        'ACCUTUNING_LOG_LEVEL': '{{dag_run.confaccutuning_env_vars.ACCUTUNING_LOG_LEVEL }}',
        'ACCUTUNING_USE_LABELER': '{{dag_run.confaccutuning_env_vars.ACCUTUNING_USE_LABELER }}',
        'ACCUTUNING_USE_CLUSTERING': '{{dag_run.confaccutuning_env_vars.ACCUTUNING_USE_CLUSTERING }}',
        'DJANGO_SETTINGS_MODULE': '{{dag_run.confaccutuning_env_vars.DJANGO_SETTINGS_MODULE }}',
        'ACCUTUNING_DB_ENGINE': '{{dag_run.confaccutuning_env_vars.ACCUTUNING_DB_ENGINE }}',
        'ACCUTUNING_DB_HOST': '{{dag_run.confaccutuning_env_vars.ACCUTUNING_DB_HOST }}',
        'ACCUTUNING_DB_PORT': '{{dag_run.confaccutuning_env_vars.ACCUTUNING_DB_PORT }}',
        'ACCUTUNING_DB_NAME': '{{dag_run.confaccutuning_env_vars.ACCUTUNING_DB_NAME }}',
        'ACCUTUNING_DB_USER': '{{dag_run.confaccutuning_env_vars.ACCUTUNING_DB_USER }}',
        'ACCUTUNING_DB_PASSWORD': '{{dag_run.confaccutuning_env_vars.ACCUTUNING_DB_PASSWORD }}',
    }
    # env_dict = {}
#     env_dict = """
#     echo "{
