...
def make_env_var(**kwargs):
    ...
    result_dict = json.loads(json.dumps(dict_str))
    env_dict = {
        'ACCUTUNING_WORKSPACE': result_dict.get("ACCUTUNING_WORKSPACE"),
        'ACCUTUNING_LOG_LEVEL': result_dict.get("ACCUTUNING_LOG_LEVEL"),
